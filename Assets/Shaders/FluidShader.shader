	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float mulTime9_g24 = _TimeParameters.x * 0.1;
				float3 appendResult8_g24 = (float3(input.ase_texcoord.xy , mulTime9_g24));
				float simplePerlin3D4_g24 = snoise( appendResult8_g24*_NoiseScale );
				float4 tex2DNode2_g21 = tex2Dlod( _PaintTexture, float4( input.ase_texcoord.xy, 0, 0.0) );
				float3 displaced_vertex_pos224 = ( ( ( ( ( simplePerlin3D4_g24 * _NoiseAmplitude ) + ( ( ( tex2DNode2_g21.r + 0.5 ) * ( 1.0 - ( tex2DNode2_g21.g + 0.5 ) ) ) - 0.5 ) ) * 2.0 ) * float3(0,0,1) ) + input.positionOS.xyz );
				 ...
				 ) : SV_Target
			{
				...
				float mulTime9_g24 = _TimeParameters.x * 0.1;
				float3 appendResult8_g24 = (float3(input.ase_texcoord4.xy , mulTime9_g24));
				float simplePerlin3D4_g24 = snoise( appendResult8_g24*_NoiseScale );
				float4 tex2DNode2_g21 = tex2D( _PaintTexture, input.ase_texcoord4.xy );
				float3 displaced_vertex_pos224 = ( ( ( ( ( simplePerlin3D4_g24 * _NoiseAmplitude ) + ( ( ( tex2DNode2_g21.r + 0.5 ) * ( 1.0 - ( tex2DNode2_g21.g + 0.5 ) ) ) - 0.5 ) ) * 2.0 ) * float3(0,0,1) ) + input.ase_texcoord5.xyz );
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.CommentaryNode;490;-1872,-48;Inherit;False;4132;1298.85;;42;448;458;294;401;457;432;489;483;486;442;420;413;439;414;411;412;224;423;422;424;438;440;333;331;334;332;430;436;441;456;425;460;459;336;338;237;337;335;484;485;487;488;Paint and Noise Displacement;1,0.6276534,0.2859483,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;486;-640,144;Inherit;False;GetNoise;-1;;24;69c321155b7140acba5e38f500e431b2;0;3;11;FLOAT;0.2;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;487;-656,608;Inherit;False;GetNoise;-1;;27;69c321155b7140acba5e38f500e431b2;0;3;11;FLOAT;0.2;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;488;-624,1088;Inherit;False;GetNoise;-1;;28;69c321155b7140acba5e38f500e431b2;0;3;11;FLOAT;0.2;False;5;FLOAT2;0,0;False;6;FLOAT;0;False;1;FLOAT;0
...
WireConnection;486;11;489;0
WireConnection;486;5;401;0
WireConnection;486;6;457;0
WireConnection;420;0;486;0
...
WireConnection;430;0;487;0
WireConnection;430;1;484;0
WireConnection;436;0;488;0
...
WireConnection;487;11;489;0
WireConnection;487;5;422;0
WireConnection;487;6;459;0
WireConnection;488;11;489;0
WireConnection;488;5;424;0
WireConnection;488;6;460;0
...
ASEEND*/
//CHKSM=94183A1E7587023CA06CECDE1DFFF65001136BD9